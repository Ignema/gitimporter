...
import { GitInfoComponent } from 'app/entities/git-info/git-info.component';
import { GitInfoService } from 'app/entities/git-info/git-info.service';
import { GitInfo } from 'app/shared/model/git-info.model';

describe('Component Tests', () => {
  describe('GitInfo Management Component', () => {
    let comp: GitInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GitInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gitInfos && comp.gitInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
